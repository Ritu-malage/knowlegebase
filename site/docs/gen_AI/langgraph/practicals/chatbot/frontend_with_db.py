...
- The history will not be lost on reloading
- Tool integration - calculator and duckduckGo
"""
import streamlit as st
import re
from backend_with_db import workflow, retrieve_all_threads
...
if "chat_threads" not in st.session_state:
    # Fetch all the threads that were previously stored in the database
...
# To maintain seperate traces on LangSmith for each threah use metadata, and run_name in the config
config = {
