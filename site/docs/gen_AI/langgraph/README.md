...
- [How to create a simple Graph workflow using LangGraph](https://github.com/Ritu-malage/knowlegebase/blob/main/site/docs/gen_AI/langgraph/practicals/practice1.ipynb)
- [How to create a linear Graph workflow with LLM using LangGraph](https://github.com/Ritu-malage/knowlegebase/blob/main/site/docs/gen_AI/langgraph/practicals/practice2.ipynb)
- [How to create a prompt chaining linear Graph Workflow using LangGraph](https://github.com/Ritu-malage/knowlegebase/blob/main/site/docs/gen_AI/langgraph/practicals/practice3.ipynb)
- [How to create simple parallel workflows](https://github.com/Ritu-malage/knowlegebase/blob/main/site/docs/gen_AI/langgraph/practicals/practice4.ipynb)
...
- [Implementation of Tools](https://github.com/Ritu-malage/knowlegebase/blob/main/site/docs/gen_AI/langgraph/practicals/practice11.ipynb)
- [ChatBot Implementation](https://github.com/Ritu-malage/knowlegebase/blob/main/site/docs/gen_AI/langgraph/practicals/chatbot/README.md)
- [RAG in LangGraph](https://github.com/Ritu-malage/knowlegebase/blob/main/site/docs/gen_AI/langgraph/practicals/practice13.ipynb)
...
- [Creating memories](https://github.com/Ritu-malage/knowlegebase/blob/main/site/docs/gen_AI/langgraph/practicals/practice21.ipynb)
