...
# Implementation
- [Predict the Salary give the level of job](https://github.com/Ritu-malage/knowlegebase/blob/main/site/docs/ML/ml_foundations/md_utils/models/linear_regression/practicals/polynomial_linear_regression.ipynb)