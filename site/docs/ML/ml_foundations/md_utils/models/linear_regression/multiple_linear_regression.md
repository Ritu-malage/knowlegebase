...
# Implementation
- [Predicting the profit of a startup](https://github.com/Ritu-malage/knowlegebase/blob/main/site/docs/ML/ml_foundations/md_utils/models/linear_regression/practicals/multiple_linear_regression.ipynb)